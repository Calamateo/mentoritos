// Import react and useState() that allows you to have state variables in functional components
          ...
          <section className="form-section">
            <div className="text-form">
              ...
              <p className="text-white">
                Por favor llena los siguientes campos para iniciar sesión en tu
                cuenta.
              </p>
            </div>
                  ...
                  >
                    <div className="row">
                      <div className="col-md-12">
                        ...
                        <button className="btn btn-dark me-1" type="submit">
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-6 card py-5 px-4" style={{ backgroundColor: "beige" }}>
                                <div className="form-container ">
                                    ...
                                    {/* <div className="col form-img" className="">
>>>>>>> e819ddd05015d776c0387553791a338ab6f000ab
