					...
					278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928 				" />
                        ...
                        <div className="col-md-6 align-self-center">
                            ...
                            <p>La página que estás buscando no existe.
                                Cómo llegaste aquí es un misterio. Pero puedes regresar a la página principal dando click al siguiente botón.
                            </p>
                            <Link to="/" className="btn btn-primary buttons rounded-pill">Inicio</Link>
                        </div>
                    </div>
                </div>
            </main>
