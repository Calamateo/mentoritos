...
return(
    ...
    <div name="item" className=" m-3 position-relative"  id= "mentorCard"  style={{"width": "18rem"}} >
        ...
        <div className="card-body position-absolute bottom-0  bg-dark bg-opacity-50 text-white col-12" style={{"width": `${props.cardWidth}` ,"border-bottom-left-radius":"30px", "border-bottom-right-radius":"30px"}}>
