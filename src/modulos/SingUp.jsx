                            ...
                            <form className="needs-validation w-100" novalidate>
                                <div className="row">
                                    <div className="col-md-12">
                                        ...
                                        <input type="text" className="form-control form-input" id="validationTooltip01"
                                        ...
                                        <input type="text" className="form-control form-input" id="validationTooltip02"
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input type="text" className="form-control form-input" id="validationTooltipUsername"
                                        ...
                                        <input type="text" className="form-control form-input" id="validationTooltip03"
                                        ...
                                        <input type="text" className="form-control form-input" id="validationTooltip04"
                                        ...
                                        <small id="emailHelp" className="form-text text-muted">No compartiremos tu correo con nadie
                                            más.</small>
                                        ...
                                        <button className="btn buttons " type="submit">Siguiente</button>
                                    </div>
                                </div>
                            </form>
