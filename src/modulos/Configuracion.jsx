...
import { actualizarUsuarioAccion, editarFotoAccion } from '../Redux/mentoritoDucks'
...
const Configuracion = () => {
    ...
    const [nombreUsuario, setNombreUsuario] = React.useState(usuario.nombre)
    ...
    const datos = db.collection(usuario.uid).doc().get()
        ...
        <div className="mt-5 text-center">
            <div className="card">
                <div className="card-body">
                    <img src={usuario.fotoURL} alt="" width="100px" className="img-fluid" />
